...
if(isset($_POST['but_submit'])){
    ...
    if ($uname != "" && $password != ""){
        ...
        $sql_query = "select count(*) as cntUser from user1 where username='".$uname."' and password='".$password."'";
            ...
            <div class="d-flex flex-lg-row flex-column-reverse">
                <div class="card card1">
                    <div class="row justify-content-center my-auto">
                        <div class="col-md-8 col-10 my-5">
                            ...
                            <div class="row justify-content-center my-3 px-3">
                                <button class="btn-block btn-color" value="submit" name="but_submit" id="but_submit">Login</button>
                            </div>
                    ...
                    <div class="bottom text-center mb-5">
                        <p  class="sm-text mx-auto mb-3">Don't have an account?<button class="btn btn-white ml-2" onclick="window.location.href = 'usersignup.php';">Create new</button></p>
                    </div>
                </div>
